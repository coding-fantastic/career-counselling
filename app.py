  ...
  #  @Rule)
   # def estp_STC(self):
    ...
    def isfp_STA(self):
        ...
        "main":"This personality type is strongly associated with creativity, energy and spontaneity. ISFP types are friendly and approachable, but some of their best work is done independently. Their ability to think creatively allows them to be excellent problem-solvers and innovators in the workplace.ISFP types learn quickly and approach their work with passion. Many choose careers that allow them to have a positive impact on others. A desk job in an office may feel tedious or stifling to ISFP personality types as they typically prefer hands-on work in an energetic environment. Despite their preference for a non-traditional workspace, ISFP personality types work well with deadlines and are capable of staying organized when managing multiple projects. They tend to work better on short-term projects as opposed to long-term planning.",
        'careers':{
